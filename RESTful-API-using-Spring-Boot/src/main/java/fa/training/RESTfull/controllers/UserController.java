package fa.training.RESTfull.controllers;

import fa.training.RESTfull.entities.User;
import fa.training.RESTfull.exceptions.ResourceNotFoundException;
import fa.training.RESTfull.repositories.UserRepository;
...
//     */
    @GetMapping("/get/{id}")
    public ResponseEntity<User> getUserById(@PathVariable(value = "id") Long userId) throws
